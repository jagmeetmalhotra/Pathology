...
function validateInteger(form) {
                ...
                for (x in oInteger) {
                    if ((form[oInteger[x][0]].type == 'text' ||
                        ...
                        if (isNaN(iValue) || isNaN(form[oInteger[x][0]].value) || !(iValue >= 0 && iValue <= 2147483647)
                        	|| (form[oInteger[x][0]].value.indexOf('.')>0)) {
                            if (i == 0) {
...
function validateFloat(form) {
                ...
                for (x in oFloat) {
                    if ((form[oFloat[x][0]].type == 'text' ||
                        ...
                        if (isNaN(iValue) || isNaN(form[oFloat[x][0]].value) || !(iValue >= 0 && iValue <= 3.4028235E38)) {
                            if (i == 0) {
