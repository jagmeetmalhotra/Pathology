...
$i_draftNumber=$_REQUEST['draftNumber'];
$i_bankName=$_REQUEST['bankName'];
$i_draftValue=$_REQUEST['draftValue'];
$i_dispatchDateStr=$_REQUEST['dispatchDateStr'];
/* LOGIN USER TO BE CREATED A SESSION VARIABLE */
$i_loginUser='1';
 /*DEBUG 
$i_lotId=3;
$i_lotName='LOT-0003';
$i_draftNumber='123456';
$i_bankName='SBI';
$i_draftValue='23.00';
$i_dispatchDateStr='2007-01-01';
$i_loginUser='1';
DEBUG ENDS*/

$insert_stmt="INSERT INTO DRAFT_DETAIL (DRAFT_NUMBER,BANK_NAME,DRAFT_VALUE,DISPATCH_DATE,FDELETED,CREATEDBY,CREATEDDATE,LOT_ID) VALUES ('$i_draftNumber','$i_bankName','$i_draftValue',str_to_date('$i_dispatchDateStr','%Y-%m-%d'),'1','$i_loginUser',now(),'$i_lotId')";
$result=mysql_query($insert_stmt,$dbh);
if($result)
	{
		print "<tr class=\"tinner\">";
		print "<td align=\"left\">Record Successfully Inserted.</td>";
		print "</tr>";
	}
?>
		<tr class="tinner">
...
?>
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
	<input type="button" name="submit1" value="Back To Main Menu" onclick=" javascript:submitForm()" class="extraLargeButton1">
	</table>
	</td>
...
<script language="JavaScript">
	<!-- // create calendar object(s) just after form tag closed
		...
		var cal2 = new calendar2(document.forms['lotFB'].elements['draftDetail.dispatchDateStr']);
		
		cal2.year_scroll = true;
		cal2.time_comp = false;
		
				var cal3 = new calendar2(document.forms['lotFB'].elements['draftDetail.recievedDateStr']);
